...
class Block_Patterns {
	...
	private function register_block_patterns() {
		$block_pattern_categories = array(
			'financio-core' => array( 'label' => esc_html__( 'Financio Core Patterns', 'financio' ) ),
		);

		if ( defined( 'GUTENVERSE' ) ) {
			$block_pattern_categories['financio-gutenverse'] = array( 'label' => esc_html__( 'Financio Gutenverse Patterns', 'financio' ) );
			$block_pattern_categories['financio-pro'] = array( 'label' => esc_html__( 'Financio Gutenverse PRO Patterns', 'financio' ) );
		}
