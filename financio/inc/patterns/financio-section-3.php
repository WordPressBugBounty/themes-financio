...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"10px","bottom":"20px"}}}} -->
<div class="wp-block-group" style="margin-top:10px;margin-bottom:20px"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"66.66%"} -->
<div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:paragraph {"className":"financio-animate financio-move-right financio-delay-3","textColor":"fifth"} -->
