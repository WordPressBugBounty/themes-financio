...
return array(
	...
	'content'    => '<!-- wp:group -->
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"padding":{"left":"20px","right":"20px"}}},"layout":{"contentSize":"1140px","type":"constrained"}} -->
<div class="wp-block-group" style="padding-right:20px;padding-left:20px"><!-- wp:columns {"className":"financio-margin-top-n80 financio-z-index-10","style":{"spacing":{"blockGap":{"left":"30px"}}}} -->
